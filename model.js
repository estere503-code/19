...
export const strategyDecisions = [
  { action: "Transition Anna's high-margin clients to Mark / approved contractor", startMonth: "Jun", cost: "10% commission on recovered revenue", effect: "Recover €10,000 per month from June after an eight-week handover; no recovery is booked before June.", evidence: "06 HR and Personnel Plan · Anna exit; 03 Sales Director Plan · 6–8 week sales cycle", rationale: "Conservative case recovers only part of Anna's former pipeline after a documented handover.", revenueDelta: [0, 0, 0, 0, 0, 10000, 10000, 10000, 10000, 10000, 10000, 10000], directDelta: [0, 0, 0, 0, 0, -1000, -1000, -1000, -1000, -1000, -1000, -1000], opexDelta: zero(), deliveryDays: 0, participants: 0, programType: "Corporate", trainerBooked: true, roomReady: true, approved: true },
  { action: "Reallocate €15,000 from broad marketing to targeted search and executive breakfasts", startMonth: "Apr", cost: "€15,000 reallocation; net annual OpEx unchanged", effect: "Cost-neutral Q2 channel test; no unproven conversion uplift is booked.", evidence: "04 Marketing Director Plan · campaign calendar; 07 Draft Operating Costs!D11:O11", rationale: "The budget records the decision while protecting the model from invented revenue.", revenueDelta: zero(), directDelta: zero(), opexDelta: zero(), deliveryDays: 0, participants: 0, programType: "Corporate", trainerBooked: true, roomReady: true, approved: true },
  ...
  { action: "Enforce Ella Fast ramp and supervised selling gate", startMonth: "May", cost: "No incremental cost; payroll already corrected in Part 1", effect: "May 0%, June 25%, July 50%, August onward full productivity.", evidence: "06 HR and Personnel Plan · Ella Fast status; 03 Sales Director Plan · first meaningful contracts June", rationale: "The control prevents premature productivity assumptions.", revenueDelta: zero(), directDelta: zero(), opexDelta: zero(), deliveryDays: 0, participants: 0, programType: "Corporate", trainerBooked: true, roomReady: true, approved: true },
